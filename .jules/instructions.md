# Jules Coding & Integration Guidelines — MyApplication3
...
## 📋 Repo Profile: android-experiment

Android experiments (MyApplication*) — ทดลองเร็ว ๆ
...
### Cooldown
- แต่ละ session ห่างกันอย่างน้อย **3 ชั่วโมง**
- สูงสุด **4 sessions/วัน** สำหรับ repo นี้
